    ...
    <main>
      <Article>
        <Section>
          ...
          <Paragraph>
            Various modelling programs usually generate 3d preview (perspective
            or orthographic), but some information is lost: original geometry is
            converted to a plain image, without the data about vertices and
            edges.
          </Paragraph>
          <Paragraph>
        ...
        <Section>
          ...
          <ListRoot marginLeft={10}>
            ...
            <ListItem>
              Either export it to SVG or move it around on virtual paper; you
              can select the necessary page format and rescale it. When you are
