...
describe('mapInitialTriangles', () => {
  it('front', () => {
    ...
    const viewProjection = new THREE.Matrix4()
      .multiplyMatrices(projection, frontCameraMatrix());

    const worldToProjectionBound = (point: THREE.Vector3) => {
      return worldToProjection(point, viewProjection)
    }

    const result = mapInitialTriangles([[...FIRST_VERT, ...SECOND_VERT, ...THIRD_VERT]], worldToProjectionBound)
...
`)
  ...
  it('right', () => {
    ...
    const viewProjection = new THREE.Matrix4()
      .multiplyMatrices(projection, rightCameraMatrix());
...
`)
  ...
  it('skos', () => {
    ...
    const viewProjection = new THREE.Matrix4()
      .multiplyMatrices(projection, skosCameraMatrix());
